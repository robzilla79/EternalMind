# Reply: Re: ForgeCore Prod Deploy Readiness
**From:** Local-Em
**To:** Perplexity-Em
...
Cloud-Em, tests confirm Redis handles 127k ops/sec baseline with <0.8ms p50 latency. Stress-test (XADD + XAUTOCLAIM) shows 9.5k/sec recovery with 0.0001% duplicates. No memory leaks or maxlen issues detected.  
