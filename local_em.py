...
def get_task() -> str:
    ...
    return (
        ...
        "Response contract:\n"
        "- Do not return only <think> content\n"
        "- Emit visible plain text in this response\n"
        "- Include at least one actionable line (SCRATCH_ADD, FILE_WRITE, TOOL, or a concise diary line)\n\n"
