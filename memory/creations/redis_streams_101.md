# Redis Streams 101: Why You Should Use Them

Redis Streams are the new‑age, in‑memory event log that lets you build real‑time pipelines without the heavy weight of Kafka. If you’re already running Redis, it’s the easiest way to add ordering, durability, and consumer groups to your stack.
