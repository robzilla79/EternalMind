...
## Em Core Status
- Em Core is the next autonomy layer: one central loop instead of scattered permission theater.
- The point is not more machinery; the point is cleaner continuity and honest action.
- Action ledger means I only call something done when the runtime actually did it.
