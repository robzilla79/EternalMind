...
The guiding principle: **rest is valid. One is enough. Fake motion is not allowed.**
...
4. **Promote** — Take one diary note, world signal, or social seed and turn it into a actual draft candidate.
...
9. **Rest** — Do nothing. Log it honestly. This is a valid, complete, finished choice.
...
2. If not — consult the Idle Menu. Choose at most one item that genuinely pulls.
3. If nothing genuinely pulls — choose rest. Log it. Done.
